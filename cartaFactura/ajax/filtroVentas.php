           ...
           <? while($registro = $resultado->fetch(PDO::FETCH_NUM)) :?>
                  <? if($registro[6]=="ACTIVA") :?>
                      <?if($registro[2]=="") :?>
                        <tr>
                                ...
                                <td class='nulo'><?= $registro[10]?></td>
                                <td class='nulo'><button class='modifica' onclick="sae(document.querySelector('.folio<?= $contador?>').value)">!</button></td>
                      ...
                      <?else :?>
                        <tr>
                                ...
                                <td class='principal'><?= $registro[10]?></td>
                  ...
                  <? else :?>
                     <tr>
                              ...
                              <td class='cancelada'><?= $registro[10]?></td>
