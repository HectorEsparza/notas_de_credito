...
$query = $con->prepare("SELECT FOLIOINTERNO, CLIENTE, NOTASAE, TOTAL, FECHA, STATUS, NOCLIENTE FROM NOTAS_VIS ORDER BY FECHA DESC LIMIT ? OFFSET ?");
$query->bind_param("ii",$limit,$offset);
$query->execute();

// vincular variables a la sentencia preparada
//$query->bind_result($id_usuario, $nombres,$apellidos);
$query->bind_result($folio, $cliente, $nota, $total, $fecha, $status, $nocliente,);
