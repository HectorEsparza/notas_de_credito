  ...
  ?>
      ...
      <header class="row" style="margin-top: 0px;">
        ...
        <div class="container col-md-4"> -->
          ...
          <form name="formulario" id="form" action="capturaCarta.php" method="post">
      ...
      <section>
        <article >
          <table width='60%' border="1" style="float: left; margin-left: 0px">


            <?php for ($i=1; $i <=24 ; $i++):?>
              <?php if($i==1): ?>
                <tr>
                  <th colspan=8 align='center'>FORMATO CARTA FACTURA <input  type="button" class="boton" value=24 id="formatoPartidas"></th>
                </tr>
                <tr>
                  <th colspan="2" style="width:25px">TIPO</th>
                  ...
                  <th colspan="2" style="width:25px">FOLIO</th>
                  <td colspan="2" align='center' id='folio' style="width:20px"></td>
                </tr>
                <tr>
                  <th style="width:25px" colspan="2" >CLIENTE</th>
                  <td colspan="2" style="width:30px" align='center'><input type='number' min=1 max=4000 class='cliente' id="clienteValor" name='cliente' required
                  ...
                  <td align='center' colspan="2" id='descuento' style="width:100px;"></td>
                </tr>
                <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <input type="hidden" id="flete" name="flete" value="0" />
                </form>
              </tr>
      ...
      document.getElementById('lis'+i).value = lis[i];
        ...
        $(document).ready(function(){
          ...
          $("#tipo").blur(function(){
            ...
            subtotal = subtotal[1];
            descuento = Math.round(((descuento/100)*subtotal)*100)/100;
            ...
            // alert("Tipo: "+tipo+ " Subtotal: "+subtotal+" Descuento: "+descuento);
          });
