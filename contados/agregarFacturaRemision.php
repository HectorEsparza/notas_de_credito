...
<body>
  ...
  <div class="row">
    ...
    <div class="container col-md-4" style="margin-left: 500px">
      <h1>Agrega Facturas/Remisiones al Contado</h1>
    </div>
  ...
  <script>
    ...
    function diaSemana(dia,mes,anio,mesEspanol){
        ...
        document.getElementById('fechaDeCargas').innerHTML = "Reporte de Contados "+dias[dt.getUTCDay()]+" "+dia+" de "+meses[mesEspanol]+" "+anio+" "+$('#folio').val();
