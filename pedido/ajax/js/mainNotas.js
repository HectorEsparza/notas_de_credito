...
function get_data_callback(){
	$.ajax({
       ...
       var valida = 2;
       var tamano = elem.cartafactura.length;
       var click = "saludo(document.querySelector('.folio"+contador+"').value)";
       var click2 = "prueba(document.querySelector('.folio"+contador+"').value)";
       var usuario = $("#gerente").val();

       if(elem.status=="NO ASOCIADO"){
              $('<tr>'+
                   ...
                   '<td class="nulo">'+elem.cartafactura+'</td>'+
               ...
               $('<tr>'+
                    ...
                    '<td class="principal">'+elem.cartafactura+'</td>'+
                   ...
                   $('<tr>'+
                     ...
                     '<td class="cancelada">'+elem.cartafactura+'</td>'+
